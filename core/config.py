...
class Settings(BaseSettings):
    ...
    jwt_secret_key: str = Field(
        default="your-secret-key-change-in-production-must-be-at-least-32-characters-long",
    ...
    jwt_expiration_minutes: int = Field(
        default=1440,
        description="JWT token expiration time in minutes (default: 1440 = 24 hours)"
    )
    ...
    def validate_jwt_secret_key(cls, v):
        ...
        if v == "your-secret-key-change-in-production-must-be-at-least-32-characters-long":
            import logging
