...
class SignatureVerificationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp):
        ...
        self.bypass_paths = {"/health", "/docs", "/redoc", "/openapi.json", "/transactions", "/leaderboard", "/bank/issue_loan", "/bank/dashboard", "/bank/repay_loan", "/bank/return_card", "/app-update/check", "/app-update/download"}
